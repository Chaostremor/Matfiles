% plot mexico 2017 BP results, rupture direction, scale and speed for 3d
% NEIC location
%
...
clear;
subplot (1, 2, 1)
load ('/Users/chaos/PreviousResearch/BackProjection/mexico/AL-neic/mexico_al_neic2103dstations10s0.5HzTo2Hz/al3dhf.mat');
...
load('/Users/chaos/PreviousResearch/BackProjection/mexico/AL-neic/mexico_al_neic2103dstations10s0.5HzTo2Hz/parret.mat');
...
dy=20;
arrow([-70, 90], [-70-dy, 90+dy*tand(azi1-270)], 12, 'Color', [160/255 160/255 160/255], 'Width', 2, 'BaseAngle', 60); hold on
text(-110, 95, 'Array', 'fontsize', 12, 'color', [160/255 160/255 160/255]);
...
text(46, 110, '2.5 km/s', 'fontsize', 11, 'color', [190/255 190/255 190/255], 'fontangle', 'italic');
text(16, 150, '5.0 km/s', 'fontsize', 11, 'color', [190/255 190/255 190/255], 'fontangle', 'italic');
...
set(gcf, 'unit', 'centimeters', 'position', [10, 5, 20, 20], 'PaperPositionMode', 'auto');
print('-dpsc2','-r600','G:\BackProjection\mexico\AL-neic\neic3d_hf.ps');
print('-depsc2','-r600','G:\BackProjection\mexico\AL-neic\neic3d_hf.eps');
print('-dpdf','-r600','G:\BackProjection\mexico\AL-neic\neic3d_hf.pdf');
