...
% close all;
%% 1. read data
% datadir = 'G:\Alxa\nodecimate\3test400_reloc_new_noorigin\' ;    % 数据所在目录
datadir = 'G:\Alxa\nodecimate\3test400_reloc_new\' ;    % 数据所在目录
...
% set velocity range
% vel = 2.5: 0.01: 6;        % S velocity range
vel = 5: 0.01: 10; 
nvel = length(vel);
...
% save('t_shift_stack_reloc.mat');
save('z_shift_stack_reloc.mat');