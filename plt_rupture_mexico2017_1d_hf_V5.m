...
%    C. Song, 2018.4.1
% Revised based on v4
%    corresponds to the  results from runteleBPv2 or 3dtimelibv2 (original methods to determine the global maximum)
...
lat0 = 15.0356;
data = load('G:\BackProjection\mexico\AL-neic\mexico_al_neic210stations10s0.5HzTo2Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
