% to mexico 1d high-freq. result, version 4.0
...
lat0 = 15.0678;
data = load('G:\BackProjection\mexico\ALtest\mexico_al210stations10s0.5HzTo2Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
%
y2inter = min(y2): 0.2: y2(1);         % loninter, latinter used to polyfix a line 
...
save('G:\BackProjection\mexico\ALtest\mexico_al210stations10s0.5HzTo2Hz\HFdots_final_al1d_hf', 'fdata','-ascii');
save('G:\BackProjection\mexico\ALtest\mexico_al210stations10s0.5HzTo2Hz\al1dhf.mat');
