...
lat0=15.0678;
tend=58;                     % ending time
data = load('G:\BackProjection\mexico\AL\mexico_al2103dstations10s0.5HzTo2Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
figure
plot(t, power, 'linestyle', '-', 'color', 'k', 'linewidth', 2);
...
corind2 = 33;
% end2 = 45;
t2 =  [t(corind2:37); t(40: end)];
lat2 = [lat(corind2:37); lat(40: end)];
lon2 = [lon(corind2:37); lon(40: end)];
power2 = [power(corind2:37); power(40: end)];
x2 = [x(corind2:37); x(40: end)];
y2 = [y(corind2:37); y(40: end)];
figure
plot(0, 0, 'kp', 'MarkerFaceColor','y', 'markersize', 20); hold on
plot(y2, x2, 'ko', 'MarkerFaceColor','r', 'markersize', 6); hold on
plot(y2(1), x2(1),'ko', 'MarkerFaceColor','b', 'markersize', 6); hold on
%
y2inter = min(y2): 0.2: y2(1);
