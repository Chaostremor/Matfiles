...
%     (cap)--> (47_18 redo crscrl correct)--> p3 (fit)
...
pg3 = [realpg; pg1(index+1: end)];


% pg1 and fitting curve
figure
distsamp = 0: 0.1: 500;
a1 = 6.104;      % alxa45
b1 = 36.1;
...
% use pg3 to renew the pg curve

% pg2 and fitting curve
figure
distsamp = 0: 0.1: 500;
a1 = 4.64;      % --> alxa??
b1 = 27.37;
...
% pg3 and fitting curve ??
% can't fit to a curve any more
...
save('alxa47_18_pg_tlag.mat', 'totallag', 'realpg', 'synpg');
