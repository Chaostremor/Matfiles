...
lat0=15.0678;
tend=60;                     % ending time
data = load('G:\BackProjection\mexico\AL0.2-1\mexico_al218stations10s0.2HzTo1Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
save('G:\BackProjection\mexico\AL0.2-1\mexico_al218stations10s0.2HzTo1Hz\HFdots_final_al1d_lf', 'fdata','-ascii');
save('G:\BackProjection\mexico\AL\mexico_al210stations10s0.5HzTo2Hz\al1dlf.mat');
