...
% to compare USGS location & NEIC location
%
% Author: C. Song, 2018.3.31
%
%
...
% 1d result
subplot (2, 2, 1)
load ('G:\BackProjection\mexico\AL-neic\mexico_al_neic210stations10s0.5HzTo2Hz\al1dhf.mat');
...
yseq2 = -29.1: 0.1: -24.8;             % lat1, lon1 used to plot
...
clear;
subplot (2, 2, 2)
load ('G:\BackProjection\mexico\AL-neic\mexico_al_neic2103dstations10s0.5HzTo2Hz\al3dhf.mat');
% plot(yuse, xuse, 'go', 'MarkerFaceColor','g', 'markersize', 2); hold on
xs1 = xuse1;
ys1 = yuse1; 
ys2 = yuse2; 
...
plot(ys1, xs1, 'ko', 'MarkerFaceColor', 'g', 'markersize', 6); hold on
plot(ys2, xs2, 'ko', 'MarkerFaceColor',[132/255 112/255 255/255], 'markersize', 6); hold on
yseq1 = -43.5: 0.1: 0;             % lat1, lon1 used to plot
xseq1 = polyval(coef11, yseq1);
ls1 = plot(yseq1, xseq1, 'linestyle', '-', 'color', 'g', 'linewidth', 2); hold on
yseq2 = -52.8: 0.1: -34.8;             % lat1, lon1 used to plot
xseq2 = polyval(coef21, yseq2);
...
print('-dpsc','-r600','G:\BackProjection\mexico\AL-neic\mexico-neic_hf.ps');
print('-dpdf','-r600','G:\BackProjection\mexico\AL-neic\mexico-neic_hf.pdf');
...
% 1d result
subplot (2, 2, 1)
load ('G:\BackProjection\mexico\AL-usgs\mexico_al_usgs210stations10s0.5HzTo2Hz\al1dhf.mat');
% plot(yuse, xuse, 'go', 'MarkerFaceColor','g', 'markersize', 2); hold on
xs1 = xuse1; 
ys1 = yuse1;
ys2 = yuse2;
...
plot(ys1, xs1, 'ko', 'MarkerFaceColor', 'g', 'markersize', 6); hold on
plot(ys2, xs2, 'ko', 'MarkerFaceColor', [132/255 112/255 255/255], 'markersize', 6); hold on
yseq1 = -33: 0.1: 0;             % lat1, lon1 used to plot
xseq1 = polyval(coef11, yseq1);
ls1 = plot(yseq1, xseq1, 'linestyle', '-', 'color', 'g', 'linewidth', 2); hold on
yseq2 = -31.5: 0.1: -26.9;             % lat1, lon1 used to plot
xseq2 = polyval(coef21, yseq2);
ls2 = plot(yseq2, xseq2, 'linestyle', '-', 'color', [132/255 112/255 255/255], 'linewidth', 2); hold on
plot(0, 0, 'rp', 'MarkerFaceColor','r','markersize', 20); hold on
axis equal;
...
clear;
subplot (2, 2, 2)
load ('G:\BackProjection\mexico\AL-usgs\mexico_al_usgs2103dstations10s0.5HzTo2Hz\al3dhf.mat');
% plot(yuse, xuse, 'go', 'MarkerFaceColor','g', 'markersize', 2); hold on
xs1 = xuse1;
ys1 = yuse1; 
ys2 = yuse2; 
...
plot(ys1, xs1, 'ko', 'MarkerFaceColor', 'g', 'markersize', 6); hold on
plot(ys2, xs2, 'ko', 'MarkerFaceColor',[132/255 112/255 255/255], 'markersize', 6); hold on
yseq1 = -40: 0.1: 0;             % lat1, lon1 used to plot
xseq1 = polyval(coef11, yseq1);
ls1 = plot(yseq1, xseq1, 'linestyle', '-', 'color', 'g', 'linewidth', 2); hold on
yseq2 = -51.5: 0.1: -26.7;             % lat1, lon1 used to plot
xseq2 = polyval(coef21, yseq2);
% xseq2 = 70: 0.1: 150;             % lat1, lon1 used to plot
% yseq2 = polyval(coef21, xseq2);
ls2 = plot(yseq2, xseq2, 'linestyle', '-', 'color', [132/255 112/255 255/255], 'linewidth', 2); hold on
...
set(gcf, 'unit', 'centimeters', 'position', [10, 5, 24, 24], 'PaperPositionMode', 'auto');
print('-dpsc','-r600','G:\BackProjection\mexico\AL-usgs\mexico-usgs_hf.ps');
print('-dpdf','-r600','G:\BackProjection\mexico\AL-usgs\mexico-usgs_hf.pdf');