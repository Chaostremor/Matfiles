% to mexico 3d high-freq. result, version 8.0
...
lat0 = 15.0356;
data = load('/Users/chaos/PreviousResearch/BackProjection/mexico/AL-neic/mexico_al_neic2103dstations10s0.5HzTo2Hz/HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
xpro2 = min(x2)-15: 2: max(x2)+2;             % lat1, lon1 used to plot
