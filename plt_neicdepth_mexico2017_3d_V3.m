% to analyze mexico 3d high-freq. result with depth, version 3.0
% get bp rupture direction, speed, length and so on, plot then, 
% ESPECIALLY FOR runteleBP3ddepthv3
%
% Author: 
%     C. Song, 2018.5.14
% Revised based on v1
% 
%    deptest, use cross-corr coef to find maximum
...
lat0 = 15.0356;
data = load('G:\BackProjection\mexico\deptest\mexico_neic_depth2103dstations10s0.5HzTo2Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
t1 =  [trup(1: 7); trup(9); trup(11: 23); trup(25: corind1)];
lat1 = [lat(1: 7); lat(9); lat(11: 23); lat(25: corind1)];
lon1 = [lon(1: 7); lon(9); lon(11: 23); lon(25: corind1)];
power1 = [power(1: 7); power(9); power(11: 23); power(25: corind1)];
alpha1 = [alpha(1: 7); alpha(9); alpha(11: 23); alpha(25: corind1)];
x1 = [x(1: 7); x(9); x(11: 23); x(25: corind1)];
y1 = [y(1: 7); y(9); y(11: 23); y(25: corind1)];
bdep1=[bdep(1: 7); bdep(9); bdep(11: 23); bdep(25: corind1)];
figure
plot(0, 0, 'kp', 'MarkerFaceColor','y', 'markersize', 20); hold on
...
corind2 = 33;
end2 = 45;
t2 =  [trup(corind2); trup(36); trup(38: end2)];
lat2 = [lat(corind2); lat(36); lat(38: end2)];
lon2 = [lon(corind2); lon(36);lon(38: end2)];
power2 = [power(corind2); power(36); power(38: end2)];
alpha2 = [alpha(corind2); alpha(36); alpha(38: end2)];
x2 = [x(corind2); x(36); x(38: end2)];
y2 = [y(corind2); y(36); y(38: end2)];
bdep2 = [bdep(corind2); bdep(36); bdep(38: end2)];

% t2 =  [trup(corind2: 34); trup(36: end2)];
% lat2 = [lat(corind2: 34); lat(36: end2)];
% lon2 = [lon(corind2: 34);lon(36: end2)];
% power2 = [power(corind2: 34); power(36: end2)];
% alpha2 = [alpha(corind2: 34); alpha(36: end2)];
% x2 = [x(corind2: 34); x(36: end2)];
% y2 = [y(corind2: 34); y(36: end2)];
% bdep2 = [bdep(corind2: 34); bdep(36: end2)];
figure
plot(0, 0, 'kp', 'MarkerFaceColor','y', 'markersize', 20); hold on
...
figure
plot(odistuse, bdepuse, 'ko', 'MarkerFaceColor','b', 'markersize', 8);
...
save('G:\BackProjection\mexico\deptest\mexico_neic_depth2103dstations10s0.5HzTo2Hz\HFdots_al3d_depth_hf', 'fdata','-ascii');
save('G:\BackProjection\mexico\deptest\mexico_neic_depth2103dstations10s0.5HzTo2Hz\HFdots_depth_profile', 'depdata','-ascii');
save('G:\BackProjection\mexico\deptest\mexico_neic_depth2103dstations10s0.5HzTo2Hz\al3ddepthhf.mat');
...
save('G:\BackProjection\mexico\deptest\mexico_neic_depth2103dstations10s0.5HzTo2Hz\profile1', 'profile1','-ascii');
save('G:\BackProjection\mexico\deptest\mexico_neic_depth2103dstations10s0.5HzTo2Hz\profile2', 'profile2','-ascii');
