% to examine the depth variation, from results in runteleBPdepthv2, 
% 
% 
% Author: 
%    C. Song, 2018.4.10

%    corresponds to the results from runteleBPdepthv2  (different methods to determine the global maximum, and loop for depth)
...
lat0 = 15.0356;
data = load('G:\BackProjection\mexico\depth\mexico_neic_depth210stations10s0.5HzTo2Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
corind1 = 32;
t1 =  [trup(1: 4); trup(6: corind1)];
lat1 = [lat(1: 4); lat(6: corind1)];
lon1 = [lon(1: 4); lon(6: corind1)];
power1 = [power(1: 4); power(6: corind1)];
alpha1 = [alpha(1: 4); alpha(6: corind1)];
x1 = [x(1: 4); x(6: corind1)];
y1 = [y(1: 4); y(6: corind1)];
bdep1= [bdep(1: 4); bdep(6: corind1)];
figure
plot(0, 0, 'kp', 'MarkerFaceColor','y', 'markersize', 20); hold on
...
%
ndata = [t1 x1 y1 dist1 power1 lat1 lon1 bdep1];
...
corind2 = 34;
end2 = 45;
t2 =  [trup(corind2); trup(36: 37); trup(39: end2)];
lat2 = [lat(corind2); lat(36: 37); lat(39: end2)];
lon2 = [lon(corind2); lon(36: 37); lon(39: end2)];
power2 = [power(corind2); power(36: 37); power(39: end2)];
x2 = [x(corind2); x(36: 37); x(39: end2)];
y2 = [y(corind2); y(36: 37); y(39: end2)];
bdep2 = [bdep(corind2); bdep(36: 37); bdep(39: end2)];
figure
plot(0, 0, 'kp', 'MarkerFaceColor','y', 'markersize', 20); hold on
...
latuse = [latuse1; lat2];
lonuse = [lonuse1; lon2];
powuse = [powuse1; power2];
bdepuse = [bdepuse1; bdep2];
...
fdata = [tuse latuse lonuse powuse bdepuse];
save('G:\BackProjection\mexico\depth\mexico_neic_depth210stations10s0.5HzTo2Hz\HFdots_depth_1d', 'fdata','-ascii');
save('G:\BackProjection\mexico\depth\mexico_neic_depth210stations10s0.5HzTo2Hz\depth1dhf.mat');
