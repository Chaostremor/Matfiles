% to mexico 1d high-freq. result, version 7.0
...
lat0 = 15.022;
data = load('G:\BackProjection\mexico\AL-usgs\mexico_al_usgs210stations10s0.5HzTo2Hz\HFdots_tc');          % HFdots dir
%%%%%%%%%%%%%%%%%%%
...
corind1 = 32;
t1 =  [trup(1: 20); trup(22: corind1)];
lat1 = [lat(1: 20); lat(22: corind1)];
lon1 = [lon(1: 20); lon(22: corind1)];
power1 = [power(1: 20); power(22: corind1)];
alpha1 = [alpha(1: 20); alpha(22: corind1)];
x1 = [x(1: 20); x(22: corind1)];
y1 = [y(1: 20); y(22: corind1)];
figure
plot(0, 0, 'kp', 'MarkerFaceColor','y', 'markersize', 20); hold on
...
save('G:\BackProjection\mexico\AL-usgs\mexico_al_usgs210stations10s0.5HzTo2Hz\HFdots_final_al1d_hf', 'fdata','-ascii');
save('G:\BackProjection\mexico\AL-usgs\mexico_al_usgs210stations10s0.5HzTo2Hz\al1dhf.mat');
